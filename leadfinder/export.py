...
COLUMNS: list[tuple[str, str]] = [
    ...
    # Рядом лежат оба охвата 2GIS независимо от того, какой выбрали:
    # расхождение между ними — готовый аргумент для разговора.
    ("rating_source_title", "Где смотрели"),
    ("rating_branch", "Рейтинг филиала"),
    ("review_count_branch", "Отзывов у филиала"),
